...
DEBUNKBOT_RESPONSE_INTERVAL = (
    int(settings.DEBUNKBOT_RESPONSE_INTERVAL)
    if settings.DEBUNKBOT_RESPONSE_INTERVAL
    else 0
)
DEBUNKBOT_CHECK_TWEETS_METRICS_INTERVAL = (
    int(settings.DEBUNKBOT_CHECK_TWEETS_METRICS_INTERVAL)
    if settings.DEBUNKBOT_CHECK_TWEETS_METRICS_INTERVAL
    else 0
)
DEBUNKBOT_CHECK_IMPACT_INTERVAL = (
    int(settings.DEBUNKBOT_CHECK_IMPACT_INTERVAL)
    if settings.DEBUNKBOT_CHECK_IMPACT_INTERVAL
    else 0
)
DEBUNKBOT_BOT_FETCH_RESPONSES_MESSAGES_INTERVAL = (
    int(settings.DEBUNKBOT_BOT_FETCH_RESPONSES_MESSAGES_INTERVAL)
    if settings.DEBUNKBOT_BOT_FETCH_RESPONSES_MESSAGES_INTERVAL
    else 0
)
DEBUNKBOT_BOT_PULL_CLAIMS_INTERVAL = (
    int(settings.DEBUNKBOT_BOT_PULL_CLAIMS_INTERVAL)
    if settings.DEBUNKBOT_BOT_PULL_CLAIMS_INTERVAL
    else 0
)
DEBUNKBOT_BOT_UPDATE_GSHEET_INTERVAL = (
    int(settings.DEBUNKBOT_BOT_UPDATE_GSHEET_INTERVAL)
    if settings.DEBUNKBOT_BOT_UPDATE_GSHEET_INTERVAL
    else 0
)
DEBUNKBOT_RESTART_STREAM_LISTENER_INTERVAL = (
    int(settings.DEBUNKBOT_RESTART_STREAM_LISTENER_INTERVAL)
    if settings.DEBUNKBOT_RESTART_STREAM_LISTENER_INTERVAL
    else 0
)
