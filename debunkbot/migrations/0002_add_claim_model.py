    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('claim_appearances', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), help_text='Links to where the claims appeared, comma separated.', null=True, size=None)),
