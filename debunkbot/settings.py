...
DEBUNKBOT_BOT_CLAIM_FIRST_APPEARANCE_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_FIRST_APPEARANCE_COLUMN')
DEBUNKBOT_BOT_CLAIM_PHRASE_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_PHRASE_COLUMN')
DEBUNKBOT_BOT_CLAIM_REVIEWED_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_REVIEWED_COLUMN')
DEBUNKBOT_BOT_CLAIM_DATE_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_DATE_COLUMN')
DEBUNKBOT_BOT_CLAIM_LOCATION_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_LOCATION_COLUMN')
DEBUNKBOT_BOT_FACT_CHECKED_URL_COLUMN = os.getenv('DEBUNKBOT_BOT_FACT_CHECKED_URL_COLUMN')
DEBUNKBOT_BOT_CLAIM_AUTHOR_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_AUTHOR_COLUMN')
DEBUNKBOT_BOT_CLAIM_CONCLUSION_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_CONCLUSION_COLUMN')
DEBUNKBOT_BOT_CLAIM_APPEARANCES_COLUMN = os.getenv('DEBUNKBOT_BOT_CLAIM_APPEARANCES_COLUMN')
