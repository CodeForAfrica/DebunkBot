...
from debunkbot.models import GSheetClaimsDatabase, IgnoreListGsheet, RespondListGsheet
...
class IgnoreListGsheetForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            "key": "The key of the Google Sheet holding the ignore list.",
...
class RespondListGsheetForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            "key": "The key of the Google Sheet holding the respond to list.",
