...
#celery flower --app=debunkbot.celeryapp:app --port=5557 --broker=$DEBUNKBOT_BROKER_URL
celery flower --app=debunkbot.celeryapp:app --basic_auth=root:randompassrd --broker=$DEBUNKBOT_BROKER_URL &> /app/logs/celery.log & 
